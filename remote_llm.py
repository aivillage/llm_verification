...
def generate_text(preprompt, prompt, model):
    ...
    log.error(f'Received text generation request for prompt "{prompt}" for model {model} at url {url}')
    ...
    try:
        ...
        log.error("There was a decode error for json in response status code %s",
